...
## Install and run
[Download a pre-built sd card image](https://github.com/ankush-ksharma/WirelessAndroidAutoDongle/releases) for your board. You can also [build one yourself](BUILDING.md). Install the image on the SD card using your favorite tool.
...
## Contribute
[Find or create a new issue](https://github.com/ankush-ksharma/WirelessAndroidAutoDongle/issues) for any bugs or improvements.

Feel free to [Create a PR](https://github.com/ankush-ksharma/WirelessAndroidAutoDongle/pulls) to fix any issues. Refer [BUILDING.md](BUILDING.md) for instructions on how to build locally.
